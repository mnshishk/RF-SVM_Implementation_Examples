...
def prepareData():
    ...
    unsw_training = pd.read_csv('./UNSW-NB15/UNSW_NB15_training-set.csv')
    unsw_testing = pd.read_csv('./UNSW-NB15/UNSW_NB15_testing-set.csv')

    data = pd.concat([unsw_training, unsw_testing])
    data = data.dropna()
    ...
    # Have to skip the str columns (gave errors)
